...
/**
 * Migrate sessions from ~/.rudrax/agent/*.jsonl to proper session directories.
 *
 * Bug in v0.30.0: Sessions were saved to ~/.rudrax/agent/ instead of
 * ~/.rudrax/agent/sessions/<encoded-cwd>/. This migration moves them
