...
import { Container, getKeybindings, Input, matchesKey, Spacer, truncateToWidth, visibleWidth, } from "@imlalitpandit/pi-tui";
...
function getGroupLabel(metadata) {
    ...
    if (metadata.source === "auto") {
        return metadata.scope === "user" ? "User (~/.rudrax/agent/)" : "Project (.rudrax/)";
    }
