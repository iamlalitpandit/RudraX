...
import { CombinedAutocompleteProvider, Container, fuzzyFilter, Loader, Markdown, matchesKey, ProcessTerminal, Spacer, setKeybindings, Text, TruncatedText, TUI, visibleWidth, } from "@rudrax/pi-tui";
...
export class InteractiveMode {
    ...
    async checkForNewVersion() {
        if (process.env.RUDRAX_SKIP_VERSION_CHECK || process.env.RUDRAX_OFFLINE)
            return undefined;
        try {
            const response = await fetch("https://registry.npmjs.org/@rudrax/pi-coding-agent/latest", {
    ...
    showNewVersionNotification(newVersion) {
        const action = theme.fg("accent", getUpdateInstruction("@rudrax/pi-coding-agent"));
