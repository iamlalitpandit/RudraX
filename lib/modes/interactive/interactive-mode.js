...
import { autoInitOllamaModel } from "../../core/auto-init.js";
...
export class InteractiveMode {
    ...
    async init() {
        ...
        if (this.options.verbose || !this.settingsManager.getQuietStartup()) {
            ...
            const welcomeText = [
                ...
                " ".repeat(Math.max(0, Math.floor((termWidth - 56) / 2))) + theme.fg("dim", "Use /help for commands, /ollama to select local Ollama models."),
                "",
            ].join("\n");
    ...
    async run() {
        ...
        // Auto-initialize Ollama model if none selected
        if (!this.session.model) {
            console.log("No model selected, auto-initializing Ollama...");
            await autoInitOllamaModel(this.session, this.footer, () => this.updateEditorBorderColor(), (msg) => this.showStatus(msg));
        }
    ...
    setupEditorSubmitHandler() {
        this.defaultEditor.onSubmit = async (text) => {
            ...
            if (text === "/model" || text.startsWith("/model ")) {
                this.editor.setText("");
                // Always show Ollama selector for RudraX
                await this.handleOllamaCommand();
                return;
            }
