...
export default function (pi: ExtensionAPI) {
  // Task command
  pi.registerCommand("task:sm-create-next-story", {
...
Use *task sm-create-next-story to execute this task workflow.
`
        }]
      });
    },
  ...
  // Task info command
  pi.registerCommand("task:sm-create-next-story:info", {
