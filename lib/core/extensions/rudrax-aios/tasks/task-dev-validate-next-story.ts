...
export default function (pi: ExtensionAPI) {
  // Task command
  pi.registerCommand("task:dev-validate-next-story", {
...
Use *task dev-validate-next-story to execute this task workflow.
`
        }]
      });
    },
  ...
  // Task info command
  pi.registerCommand("task:dev-validate-next-story:info", {
