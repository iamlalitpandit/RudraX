...
export default function (pi: ExtensionAPI) {
  // Task command
  pi.registerCommand("task:dev-optimize-performance", {
...
Use *task dev-optimize-performance to execute this task workflow.
`
        }]
      });
    },
  ...
  // Task info command
  pi.registerCommand("task:dev-optimize-performance:info", {
