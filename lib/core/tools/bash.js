...
import { Container, Text, truncateToWidth } from "@imlalitpandit/pi-tui";
...
function getTempFilePath() {
    ...
    return join(tmpdir(), `rudrax-bash-${id}.log`);
}
...
/**
 * Create bash operations using RudraX's built-in local shell execution backend.
 *
 * This is useful for extensions that intercept user_bash and still want RudraX's
