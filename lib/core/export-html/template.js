    (function() {
      ...
      const injectedParams = document.querySelector('meta[name="rudrax-url-params"]');
      ...
      function buildShareUrl(entryId) {
        ...
        const baseUrlMeta = document.querySelector('meta[name="rudrax-share-base-url"]');
      ...
      const SIDEBAR_WIDTH_STORAGE_KEY = 'rudrax-share:v1:sidebar-width';
