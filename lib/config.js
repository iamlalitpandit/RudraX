...
export function getPackageDir() {
    ...
    const envDir = process.env.RUDRAX_PACKAGE_DIR;
    if (envDir) {
        if (envDir === "~")
            return homedir();
...
export function getThemesDir() {
    ...
    // Theme is in modes/interactive/theme/ relative to src/, dist/, or lib/
    const packageDir = getPackageDir();
    const srcOrDist = existsSync(join(packageDir, "src")) ? "src" : existsSync(join(packageDir, "lib")) ? "lib" : "dist";
...
export const APP_NAME = pkg.piConfig?.name || "rudrax";
export const CONFIG_DIR_NAME = pkg.piConfig?.configDir || ".rudrax";
export const VERSION = pkg.version;
// e.g., PI_CODING_AGENT_DIR or TAU_CODING_AGENT_DIR
export const ENV_AGENT_DIR = `${APP_NAME.toUpperCase()}_CODING_AGENT_DIR`;
const DEFAULT_SHARE_VIEWER_URL = "https://rudrax.dev/session/";
/** Get the share viewer URL for a gist ID */
export function getShareViewerUrl(gistId) {
    const baseUrl = process.env.RUDRAX_SHARE_VIEWER_URL || DEFAULT_SHARE_VIEWER_URL;
    return `${baseUrl}#${gistId}`;
}
// =============================================================================
// User Config Paths (~/.rudrax/agent/*)
// =============================================================================
/** Get the agent config directory (e.g., ~/.rudrax/agent/) */
