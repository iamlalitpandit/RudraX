...
metadata:
  ...
  original_name: "osint-investigation"
---
...
# $RUDRAX_OSINT_CACHE/icij/ (default: ~/.cache/rudrax-osint/icij/).
...
# Set RUDRAX_OSINT_UA=your-app/1.0 (your@email) to identify yourself
