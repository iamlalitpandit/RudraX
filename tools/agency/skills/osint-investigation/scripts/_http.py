...
DEFAULT_UA = (
    "rudrax-osint-investigation/0.2 "
    "(+https://github.com/iamlalitpandit/RudraX; "
    "set RUDRAX_OSINT_UA env var to identify yourself per "
...
def get(
    ...
    *,
    ...
    h = {"User-Agent": user_agent or os.environ.get("RUDRAX_OSINT_UA", DEFAULT_UA)}
    if headers:
        h.update(headers)
