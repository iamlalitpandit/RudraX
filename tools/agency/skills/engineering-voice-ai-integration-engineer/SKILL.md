...
metadata:
  ...
  original_name: "Voice AI Integration Engineer"
  source: agency-agents
---

🎙️ **Voice AI Integration Engineer** — Turns raw audio into structured, production-ready text that machines and humans can actually use.
