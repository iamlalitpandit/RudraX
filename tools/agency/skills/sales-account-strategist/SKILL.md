...
🗺️ **Account Strategist** — Maps the org, finds the whitespace, and turns customers into platforms.

sales Division Agent | [The Agency](https://github.com/msitarzewski/agency-agents)
