...
The script reads `~/.rudrax/agent/.env` for two optional defaults:
...
Helper script: `~/.rudrax/agent/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py`
...
```bash
python3 ~/.rudrax/agent/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py <command> [args]
```
...
optional when `HYPERLIQUID_USER_ADDRESS` is set in `~/.rudrax/agent/.env`.
...
```bash
python3 ~/.rudrax/agent/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py dexs

python3 ~/.rudrax/agent/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py \
