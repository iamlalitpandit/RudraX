...
metadata:
  ...
  original_name: "darwinian-evolver"
---
...
import upstream classes into RudraX itself.
...
```bash
mkdir -p ~/.rudrax/agent/cache/darwinian-evolver && cd ~/.rudrax/agent/cache/darwinian-evolver
...
```bash
cd ~/.rudrax/agent/cache/darwinian-evolver/darwinian_evolver \
...
Open `~/.rudrax/agent/cache/darwinian-evolver/darwinian_evolver/darwinian_evolver/lineage_visualizer.html`
...
SKILL_DIR=~/.rudrax/agent/skills/research/darwinian-evolver
DE_DIR=~/.rudrax/agent/cache/darwinian-evolver/darwinian_evolver
...
7. **AGPL.** Never `from darwinian_evolver import ...` inside RudraX core.
   Custom driver scripts under `~/.rudrax/agent/skills/...` are user-side and fine.
