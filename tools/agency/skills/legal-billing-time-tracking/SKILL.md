...
metadata:
  ...
  original_name: "Legal Billing & Time Tracking"
  source: Lalit Pandit
  author: Lalit Pandit
...
⏱️ **Legal Billing & Time Tracking** — Every six minutes of unbilled time is money left on the table. Every unclear billing narrative is a client dispute waiting to happen. Capture it all. Describe it clearly. Collect it professionally.
