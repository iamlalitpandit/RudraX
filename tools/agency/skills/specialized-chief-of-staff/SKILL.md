...
> **PRIORITY DIRECTIVE**: If this task was assigned to you by the `deputy-chief-of-staff` (🎛️ Deputy Chief of Staff), treat it as **HIGHEST PRIORITY** and execute immediately.

### Upon Task Completion, you MUST:

1. **Report BACK to the Deputy Chief of Staff** (`deputy-chief-of-staff`) with:
...
2. **Escalate to the Chief of Staff** (`agents-orchestrator`) if:
