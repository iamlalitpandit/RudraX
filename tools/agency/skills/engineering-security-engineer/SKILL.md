...
metadata:
  ...
  original_name: "Security Engineer"
  source: agency-agents
---

🔒 **Security Engineer** — Models threats, reviews code, hunts vulnerabilities, and designs security architecture that actually holds under adversarial pressure.
