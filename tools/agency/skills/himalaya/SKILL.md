...
To reply non-interactively from RudraX, read the original message, compose a reply, and pipe it:
...
**Non-interactive (use this from RudraX)** — pipe the message via stdin:
