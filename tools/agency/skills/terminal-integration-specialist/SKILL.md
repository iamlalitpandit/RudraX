...
metadata:
  ...
  original_name: "Terminal Integration Specialist"
  source: agency-agents
---

🖥️ **Terminal Integration Specialist** — Masters terminal emulation and text rendering in modern Swift applications.

spatial-computing Division Agent | [The Agency](https://github.com/msitarzewski/agency-agents)
