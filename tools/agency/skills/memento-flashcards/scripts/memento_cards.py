...
Data file: $RUDRAX_CODING_AGENT_DIR/skills/productivity/memento-flashcards/data/cards.json
"""
...
_RUDRAX_CODING_AGENT_DIR = Path(os.environ.get("RUDRAX_CODING_AGENT_DIR", Path.home() / ".rudrax"))
DATA_DIR = _RUDRAX_CODING_AGENT_DIR / "skills" / "productivity" / "memento-flashcards" / "data"
